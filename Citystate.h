...
private:
    ...
    fmt::rgb color;
public:
    Citystate(std::string name, CitystateType type, std::vector<Unit*> units, int gold, int goldGain, int science, int scienceGain, int x, int y, int health, int maxHealth, fmt::rgb color);
